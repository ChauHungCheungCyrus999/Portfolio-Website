...
const projects = [
  ...
  { number: '02', title: 'Canada Vehicle Emissions Analysis', description: 'Created a RESTful API with GET, POST, DELETE, and PUT routes, returning JSON information to the database and parsing records when retrieving them.', tags: ['R'], link: 'https://github.com/ChauHungCheungCyrus999/Canada-Vehicle-Emissions-Analysis', linkType: 'GitHub' },
  { number: '03', title: 'My Own Personal Blog', description: 'A personal blog where I share my thoughts on life and reflect on my own experiences.', tags: ['HTML', 'CSS', 'JavaScript'], link: 'https://chauhungcheungcyrus999.github.io/CyBlog', linkType: 'Website' },
  { number: '04', title: 'Extrovert vs. Introvert Behavior Data Analysis', description: 'Analyzed behavior data to identify key values, create thresholds, train a Logistic Regression model, and test the results.', tags: ['Python'], link: 'https://github.com/ChauHungCheungCyrus999/ExtroverVsIntrovert', linkType: 'GitHub' },
  { number: '05', title: 'Object-Oriented System Design Project', description: 'Designed software using use-case, class, and sequence diagrams, then completed the project with a prototype, presentation, and report.', tags: ['Java', 'BlueJ', 'Visual Paradigm'], link: 'https://github.com/ChauHungCheungCyrus999/SoftwareDesign', linkType: 'GitHub' },
]
